                ...
                <div className="thongTinChungContainer">
                    <div className="thongTinChungColumn1">
                        ...
                        <div className="columnChildren1">
                            ...
                            <div style={{display: 'flex'}}>
                                ...
                                <div className="columnChildren1Info">{cong_van_versionData.phong_ban_nhan}</div>
                            </div>
                            <div style={{display: 'flex'}}>
                                <div className="columnChildren1Title">Người nhận và xử lý:</div>
                                <div className="columnChildren1Info">{cong_van_versionData.nguoi_xu_ly}</div>
                            </div>
                            <div style={{display: 'flex'}}>
                        ...
                        <div className="columnChildren2">
                            <div style={{display: 'flex'}}>
                                ...
                                <div className="columnChildren2Info">{cong_van_versionData.muc_do_uu_tien}</div>
                            </div>
                            <div style={{display: 'flex'}}>
                                <div className="columnChildren2Title">Loại công văn:</div>
                                <div className="columnChildren2Info">{cong_van_versionData.loai_cong_van}</div>
                            </div>
                            <div style={{display: 'flex'}}>
                                <div className="columnChildren2Title">Bộ phận phát hành:</div>
                                <div className="columnChildren2Info">{cong_van_versionData.phong_ban_phat_hanh}</div>
                            </div>
                            <div style={{display: 'flex'}}>
                                <div className="columnChildren2Title">Người duyệt và ký:</div>
                                <div className="columnChildren2Info">{cong_van_versionData.nguoi_ky}</div>
                            </div>
                            <div style={{display: 'flex'}}>
                    ...
                    <div className="thongTinChungColumn2">
                        ...
                        <div style={{display:'flex'}}>
                            ...
                            <div className="column2Info">{cong_van_versionData.tinh_trang_xu_ly}</div>
                        </div>
                        <div style={{display:'flex'}}>
                            <div className="column2Title">Người tạo:</div>
                            <div className="column2Info">{cong_van_versionData.nguoi_tao}</div>
                        </div>
                        <div style={{display:'flex'}}>
