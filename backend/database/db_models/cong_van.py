...
class CongVanDi:
    ...
    ai_model_versions = relationship("AIModelVersion", back_populates="ai_model", order_by="AIModelVersion.create_at", primaryjoin="AIModelVersion.ai_model_id==AIModel.id")
